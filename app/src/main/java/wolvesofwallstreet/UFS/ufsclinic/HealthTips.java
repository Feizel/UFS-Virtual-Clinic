...
public class HealthTips extends AppCompatActivity {
    RecyclerView healthyEatingRecycler;
    ...
    private void setCourseRecycler(List<Course> courseList) {
        ...
        healthyEatingRecycler = findViewById(R.id.courseRecycler);
        healthyEatingRecycler.setLayoutManager(layoutManager);

        courseAdapter = new CourseAdapter(this, courseList);
        healthyEatingRecycler.setAdapter(courseAdapter);
